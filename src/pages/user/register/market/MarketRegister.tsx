...
import { styles } from './MarketRegister.styles'
...
export const MarketRegister = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholderTextColor={Colors.gray} style={styles.input} value={name} onChangeText={value => setName(value)} placeholder="CPF / CNPJ *" />
      <TextInput placeholderTextColor={Colors.gray} style={styles.input} value={name} onChangeText={value => setName(value)} placeholder="ÁREA DE ATUAÇÃO *" />
      <TextInput placeholderTextColor={Colors.gray} style={styles.input} value={name} onChangeText={value => setName(value)} placeholder="DESCRIÇÃO *" />
